...
<form action="EmpInsert.do" 
	...
	<select name="manager_id">
		<%List<EmpVO> magList = (List<EmpVO>) request.getAttribute("magList");
			for(EmpVO empVO : magList) {			
		%>
			<option value="<%=empVO.getManager_id()%>"> <%=empVO.getFirst_name()%><%=empVO.getLast_name() %>
		<% } %>
	</select></div>
